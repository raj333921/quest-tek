  ...
  return (
    ...
    <header className="">
      ...
      <div className="space-y-12">
            ...
            <div className="sm:col-span-3">
              ...
              <div className="mt-2">
                <input id="first-name"
                  ...
                  onChange={(e) => {setInputVal({...inputVal,firstName: e.target.value});
            ...
            <div className="sm:col-span-3">
              ...
              <div className="mt-2">
                <input
                  ...
                  onChange={(e) => {setInputVal({...inputVal,lastName: e.target.value});
            ...
            <div className="sm:col-span-3">
              ...
              <div className="mt-2">
                <input
                  ...
                  onChange={(e) => {setInputVal({...inputVal,emailId: e.target.value});
        ...
        {alert && <div class="p-4 mb-4 text-sm text-green-800 rounded-lg bg-green-50 middle:bg-gray-800 dark:text-green-400" role="alert">
              <span class="font-medium">Your application is successfully submitted. Our Team will be back to you !</span>
            </div>}
            {erAlert && <div class="p-4 mb-4 text-sm text-green-800 rounded-lg bg-green-50 middle:bg-gray-800 dark:text-green-400" role="alert">
                          <span class="font-medium">Your application is unsuccesfull :( , Drop us an email : {Constants.EMAILID}</span>
                        </div>}
